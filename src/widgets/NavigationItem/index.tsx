...
import "./styles.scss"
import BakaiLogo from "@/shared/assets/icons/bakai-logo.svg"
...
export const NavigationItem = ({ icon, title, rightIcon,bakai_logo = false,onBack,onClick }: Props) => {
    return (
        <div className="navigation-list">
            <div className="navigation-list__content">
